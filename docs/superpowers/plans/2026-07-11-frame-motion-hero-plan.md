...
- [ ] **Step 1: Assert the target contract**
...
- [ ] **Step 1: Remove hotspot presentation**
...
- [ ] **Step 2: Add the single motion affordance**
...
- [ ] **Step 3: Make the video non-playing by default**
...
- [ ] **Step 3: Integrate Motion Policy**
...
- [ ] **Step 4: Update localized labels**
...
- [ ] **Step 1: Run RED then GREEN acceptance**
- [ ] **Step 2: Inspect headed screenshots at desktop and mobile**
- [ ] **Step 3: Run Chromium/Firefox/WebKit matrix and keyboard/reduced checks**
- [ ] **Step 4: Run a 10-second dropped-frame measurement after warmup**
- [ ] **Step 5: Run `git diff --check` and Gitleaks**
...
- [ ] **Step 1: Stage only the scoped files**
- [ ] **Step 2: Commit `feat: rebuild hero as frame motion experience`**
- [ ] **Step 3: Push the branch, never merge/deploy**
- [ ] **Step 4: Update Wiki-Brain SNAP, project page, and log**
